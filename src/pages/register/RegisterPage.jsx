...
import { Paper, Container,Typography, Grid, Avatar, CssBaseline, TextField, Select, MenuItem, Button, FormControl, InputLabel, Link, Autocomplete } from '@mui/material/'
...
export default function RegisterPage() {
    ...
    const submitForm = async () => {
        ...
        if (nameValue === "") {
            toggle();
            setErrorShow("The name cannot be empty");
            ...
            toggle();
            setErrorShow("The country and the city are required");
        } else if (roleValue === "") {
            toggle();
            setErrorShow("Please select a role");
